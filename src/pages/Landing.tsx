          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-4.75rem)] w-[min(100%-2rem,78rem)] items-center gap-14 py-16 lg:grid-cols-[minmax(0,1.02fr)_minmax(28rem,0.98fr)] lg:gap-14 lg:py-20">
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-3 py-1.5 text-xs font-bold text-[#014BAA] shadow-sm backdrop-blur-xl">
                ...
                The career network built for outcomes
            ...
            <motion.div initial={{ opacity: 0, y: 24, scale: 0.98 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.65, delay: 0.08 }} className="relative mx-auto w-full max-w-[37rem] lg:max-w-none">
              ...
              <div className="landing-dashboard-frame landing-shine relative overflow-hidden rounded-[2rem] border border-white bg-white/65 p-3 shadow-[0_32px_90px_rgba(15,23,42,0.16)] backdrop-blur-2xl sm:p-4">
                <div className="mb-3 flex items-center justify-between px-2 py-1">
                  ...
                  <div className="flex items-center gap-1.5 text-[0.65rem] font-bold uppercase tracking-[0.14em] text-slate-500"><ShieldCheck className="h-3.5 w-3.5 text-[#014BAA]" /> Career signal</div>
                </div>
                ...
                <div className="overflow-hidden rounded-[1.4rem] bg-[#f8fafc] text-slate-950 shadow-2xl">
                  <div className="relative overflow-hidden bg-gradient-to-br from-[#eef4ff] via-white to-[#F8F3F0] px-5 pb-5 pt-6 sm:px-6">
                    ...
                    <div className="relative mt-6 rounded-2xl border border-white/80 bg-white/80 p-4 shadow-sm backdrop-blur-xl">
                      <div className="flex items-end justify-between"><div><p className="text-[0.65rem] font-extrabold uppercase tracking-[0.13em] text-slate-400">Career signal</p><p className="mt-1 text-sm font-extrabold">Excellent profile strength</p></div><p className="text-2xl font-black tracking-[-0.06em] text-[#155eef]">94<span className="text-xs">%</span></p></div>
        ...
        <section id="features" className="relative py-20 sm:py-28">
          ...
          <div className="relative mx-auto w-[min(100%-2rem,78rem)]">
            <div className="mx-auto max-w-3xl text-center">
              <span className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[0.68rem] font-extrabold uppercase tracking-[0.13em] text-blue-700"><Sparkles className="h-3.5 w-3.5" /> A better way to move forward</span>
            ...
            <div className="mt-14 grid gap-4 lg:grid-cols-12">
              ...
              <article className="landing-polish-card relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8 lg:col-span-4">
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#014BAA] text-white shadow-lg shadow-blue-500/20"><Play className="h-5 w-5 fill-current" /></span>
                <h3 className="mt-8 text-2xl font-extrabold tracking-[-0.045em] text-slate-950">Careers, in motion.</h3>
                <p className="mt-3 text-sm font-medium leading-6 text-slate-600">Share a project walkthrough, a day in your role or one useful idea in 60 seconds.</p>
                <div className="mt-8 flex h-36 items-end gap-2 overflow-hidden rounded-2xl bg-gradient-to-br from-[#014BAA] via-[#155eef] to-[#60a5fa] p-4 text-white"><div className="flex-1"><span className="rounded-full bg-black/20 px-2 py-1 text-[0.6rem] font-bold backdrop-blur">#BuildInPublic</span><p className="mt-3 text-sm font-extrabold">How I shipped my first design system</p></div><span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-[#014BAA] shadow-lg"><Play className="ml-0.5 h-4 w-4 fill-current" /></span></div>
              </article>
