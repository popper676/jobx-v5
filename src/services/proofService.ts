...
export const PROOF_OPPORTUNITIES: ProofOpportunity[] = [
  { id: 'mission-accessibility', type: 'mission', title: 'Audit an accessible checkout', employer: 'Northstar Labs', employerInitials: 'NS', description: 'Review a real checkout flow, identify accessibility gaps, and present a prioritized remediation plan.', skill: 'Product Design', difficulty: 'Intermediate', duration: '3–4 hours', points: 8, participants: 184, deadline: '7 days left', featured: true },
  { id: 'mission-api', type: 'mission', title: 'Design a resilient notification API', employer: 'Lumen Systems', employerInitials: 'LS', description: 'Propose an API contract, retry strategy, and observability plan for a high-volume notification service.', skill: 'Backend Engineering', difficulty: 'Advanced', duration: '5–6 hours', points: 10, participants: 96, deadline: '10 days left' },
  { id: 'mission-growth', type: 'mission', title: 'Find the onboarding drop-off', employer: 'Orbit Commerce', employerInitials: 'OC', description: 'Use a sample product funnel to find friction, form a hypothesis, and recommend one measurable experiment.', skill: 'Product Analytics', difficulty: 'Intermediate', duration: '2–3 hours', points: 7, participants: 241, deadline: '5 days left' },
  { id: 'mission-campaign', type: 'mission', title: 'Launch a zero-budget campaign', employer: 'Arc Studio', employerInitials: 'AS', description: 'Build a channel strategy and a week-one content plan for an early-stage sustainability product.', skill: 'Growth Marketing', difficulty: 'Beginner', duration: '2 hours', points: 5, participants: 329, deadline: '12 days left' },
  { id: 'mission-dashboard', type: 'mission', title: 'Prototype an operations dashboard', employer: 'WaveLab', employerInitials: 'WL', description: 'Turn a messy logistics brief into a clear dashboard prototype with decisions, states, and edge cases.', skill: 'UI/UX', difficulty: 'Advanced', duration: '4–5 hours', points: 9, participants: 118, deadline: '8 days left' },
  { id: 'challenge-open-source', type: 'challenge', title: 'Open-source contribution sprint', employer: 'JobX Community', employerInitials: 'JX', description: 'Improve documentation, fix an issue, or review a pull request in a participating open-source project.', skill: 'Collaboration', difficulty: 'Beginner', duration: 'Flexible', points: 6, participants: 872, deadline: 'Always open', featured: true },
  { id: 'challenge-data-story', type: 'challenge', title: 'Tell a story with public data', employer: 'Civic Data Collective', employerInitials: 'CD', description: 'Explore an open dataset and publish a concise visual story that makes one useful insight understandable.', skill: 'Data Visualization', difficulty: 'Intermediate', duration: 'Weekend', points: 8, participants: 413, deadline: '14 days left' },
  { id: 'challenge-climate', type: 'challenge', title: 'Climate product design jam', employer: 'Greenhouse Network', employerInitials: 'GN', description: 'Join a small team, define a climate behavior problem, and contribute to a tested solution concept.', skill: 'Team Contribution', difficulty: 'Intermediate', duration: '1 week', points: 9, participants: 265, deadline: 'Starts Monday' },
